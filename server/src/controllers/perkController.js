...
export async function updatePerk(req, res, next) {
  try {
    ...
    // Validate only provided fields, do not apply defaults
    const { value, error } = updateSchema.validate(req.body, { presence: 'optional', stripUnknown: true, noDefaults: true });
    if (error) 
